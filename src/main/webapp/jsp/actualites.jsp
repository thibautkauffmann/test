...
<script type="text/javascript" src="vendor/bootstrap-news-box/scripts/jquery.bootstrap.newsbox.min.js"></script>
		...
		<div class="col-md-12 column">
			<nav class="navbar navbar-default navbar-fixed-top" role="navigation">
				<div class="navbar-header">
					...
					<a class="navbar-brand" href="#">Les actualit�s</a>
				</div>

				<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
					<ul class="nav navbar-nav">
						<li>
							<a href="ca" class="dropdown-toggle" data-toggle="dropdown">Cabinets<strong class="caret"></strong></a>
							<ul class="dropdown-menu">
								<li>
									<a href="cabinet.jsp">Cabinet de ...</a>
								</li>
								<li>
									<a href="cabinet.jsp">Cabinet de ...</a>
								</li>
						...
						<li class="dropdown">
							<a href="actualites.jsp" class="dropdown-toggle" data-toggle="dropdown">Actualit�s<strong class="caret"></strong></a>
							<ul class="dropdown-menu">
								<li>
									<a href="#">Droit priv�</a>
								</li>
			...
			<div class="page-header">
				<h1>
					Les actualit�s juridiques&nbsp;<small>Ceci concerne les news</small>
				</h1>
			</div>
